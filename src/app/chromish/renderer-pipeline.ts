  ...
  registerToolcraftRendererPipeline<ChromishPipelineContracts>()({
    ...
    passes: [
      ...
      },
      {
        ...
        id: "chrome-hdr",
        inputs: ["svg-extrusion", "chrome.*", "view.orbit", "motion.*", "timeline", "canvas.renderScale"],
    ...
    interactionInvalidation: [
      ...
      { interaction: "control-change", invalidates: ["chrome-hdr", "tone-map"], mustNotInvalidate: ["svg-extrusion"], targets: ["chrome.tint", "chrome.roughness", "chrome.reflectionContrast", "chrome.studioRotation", "chrome.exposure", "motion.direction", "motion.startAngle", "view.orbit", "appearance.background", "export.includeBackground"] },
